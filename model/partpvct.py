...
from model.utils import create_pointnet_components, create_mlp_components, create_pvct_components

__all__ = ['pvct_partseg']
...
class pvct_partseg(nn.Module):
    # blocks = ((64, 1, 30), (128, 2, 15), (512, 1, None), (1024, 1, None))
    blocks = ((96, 1, 30, 1, 1, 3), (192, 1, 15, 2, 3, 6), (512, 1, None,None,None,None), (1024, 1, None,None,None,None))
    def __init__(self, num_classes, num_shapes, extra_feature_channels=3,
        ...
        layers, channels_point, concat_channels_point = create_pvct_components(
            blocks=self.blocks, in_channels=self.in_channels, normalize=False,
            width_multiplier=width_multiplier, voxel_resolution_multiplier=voxel_resolution_multiplier,model='PVCTConv'
        )
